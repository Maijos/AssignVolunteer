// chapter 5 practice exercise 238-294
...
public class AssignVolunteer
{
	public static void main(String[] args)
	{
		...
		final String CLOTHING_PRICER = "Noodle";
		final String FURNITURE_PRICER = "Russle";
		final String ELECTRONICS_PRICER = "2D";
		final String OTHER_PRICER = "Murdoc";
